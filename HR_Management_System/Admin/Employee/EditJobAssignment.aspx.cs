...
{
    public partial class EditJobAssignment : System.Web.UI.Page
    {
        ...
        private void loadDesignation()
        {
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                SqlDataAdapter dataAdapter =
                    new SqlDataAdapter("SELECT DesignationID, DesignationTitle FROM Designation", con);
        ...
        private void loadEmployee()
        {
            ...
            {
                SqlDataAdapter dataAdapter =
                    new SqlDataAdapter("SELECT EmpID, (EmpFstName +' '+ EmpLstName) as Name FROM Employees", con);
                DataTable dt = new DataTable();
                dataAdapter.Fill(dt);
                con.Open();
        ...
        private void GetJobAssginmentInfo()
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                {
                    ddlEmployee.SelectedValue = row["EmpFstName"].ToString() + row["EmpLstName"].ToString();
                    ddlDesignation.SelectedValue = row["DesignationTitle"].ToString();
                    txtJoiningDate.Text = row["JoiningDate"].ToString();
                    txtJoiningSalary.Text = row["JoiningSalary"].ToString();
                    txtLeavingDate.Text = row["LeavingDate"].ToString();
                    ...
                    else if (row["IsActive"].ToString() == "False")
                    {
        ...
        protected void BtnSubmit_OnClick(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                cmd.Parameters.AddWithValue("@jobassignmentid", Request.QueryString["id"]);
