<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminArea.Master" AutoEventWireup="true" CodeBehind="EditEmployee.aspx.cs" Inherits="HR_Management_System.Admin.Employee.EditEmployee" %>
            ...
            <div class="card-body">
                <div id="EmpForm" runat="server" data-parsley-validate="" novalidate="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <%--<input type="text" id="LastName" runat="server" required=""  class="form-control" placeholder="Enter your last name" />--%>
                            <input type="text" runat="server" id="LastName" name="LastName" value="" class="form-control" placeholder="Enter your last name" />
                            </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <asp:Label AssociatedControlID="imgEmp" class="col-12 col-sm-3 col-form-label text-sm-right" runat="server">Image</asp:Label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <asp:Image ID="imgEmp" runat="server" CssClass="img-thumbnail" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row text-right">
                        <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                            <asp:Button ID="BtnUpdate" class="btn btn-space btn-primary" runat="server" Text="Update"  OnClick="BtnUpdate_Click"></asp:Button>
                        </div>
                    </div>
                </div>
            </div>
